# agent1-service-property-deals/agent_config.py
...
DOMAIN_LABEL = "property_deals"
ALLOWED_TABLES = domain[7]

history_repo = build_history_repo(table_name="history_property_deals")
...
config = AgentConfig(
    ...
    description="Property & Deals sub-agent microservice for deterministic data retrieval",
    error_label="Property/Deals",
