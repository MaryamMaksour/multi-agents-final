...
-- error message.
--
-- The previous version of this file could not be applied at all: all
-- services shared one env_file and therefore one database user. The
-- per-service PG_USER/PG_PASSWORD in docker-compose.v2.yml is what makes
-- these roles usable.
