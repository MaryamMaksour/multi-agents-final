# agent2-service-people/agent_config.py
...
DOMAIN_LABEL = "people"
ALLOWED_TABLES = domain[8]

history_repo = build_history_repo(table_name="history_people")
...
config = AgentConfig(
    ...
    description="People (Organization + CRM) sub-agent microservice for deterministic data retrieval",
    error_label="People",
